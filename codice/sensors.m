...
% Accelerometer
std_dev_accx = 0.02;  % [m/s^2] 
std_dev_accy = 0.02;  % [m/s^2]
std_dev_accz = 0.02;  % [m/s^2]
freq_acc = 50;  % [Hz]

% gyro
bias_gyro = [0.02 0.01 0.007];  % [m/s^2]
std_dev_gyro1 = 1e-7; % [rad/s]   
std_dev_gyro2 = 1e-7; % [rad/s]
std_dev_gyro3 = 1e-7; % [rad/s]
freq_gyro = 10;  % [Hz]
...
q_quat_3 = 1e-12;
q_quat_4 = 1e-12;
q_omega_1 = 1e-12;  % Angular rate
q_omega_2 = 1e-12;
q_omega_3 = 1e-12;
q_bias_1 = 10^(-14);   % Gyro Byass
q_bias_2 = 10^(-14);  
q_bias_3 = 10^(-14);
...
% measure covariance
UWB_cov = [std_dev_UWB1^2 std_dev_UWB2^2 std_dev_UWB1^2];
